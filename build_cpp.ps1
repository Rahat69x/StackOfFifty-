# AegisCore C++20 Build Script (Windows PowerShell)
Write-Host "=======================================================" -ForegroundColor Cyan
Write-Host "       Compiling AegisCore Native C++20 Server         " -ForegroundColor Cyan
Write-Host "=======================================================" -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "    Binary: $scriptPath\aegiscore_server.exe" -ForegroundColor White
    $binSize = (Get-Item "aegiscore_server.exe").Length / 1MB
