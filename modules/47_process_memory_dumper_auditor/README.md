# Process Injection & Memory Auditor
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/process_memory_dumper_auditor/status`).
...
│   └── process_memory_dumper_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_process_memory_dumper_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/process_memory_dumper_auditor.git
   cd process_memory_dumper_auditor
   ```
...
- `GET /process_memory_dumper_auditor/status`: Current execution metrics and telemetry summary
