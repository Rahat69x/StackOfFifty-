...
## Description
Detects rogue access points, weak WEP/WPA authentication, and de-auth flood alerts
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/wireless_security_auditor/status`).
...
│   └── wireless_security_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_wireless_security_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/wireless_security_auditor.git
   cd wireless_security_auditor
   ```
...
- `GET /wireless_security_auditor/status`: Current execution metrics and telemetry summary
