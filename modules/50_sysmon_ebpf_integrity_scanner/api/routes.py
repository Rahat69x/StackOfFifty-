"""
API routes for System Call & Sysmon Telemetry Integrity Scanner.
"""
from fastapi import APIRouter, HTTPException

router = APIRouter(prefix="/sysmon_ebpf_integrity_scanner", tags=["System Call & Sysmon Telemetry Integrity Scanner"])
