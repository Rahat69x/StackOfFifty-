"""
Module entry point for System Call & Sysmon Telemetry Integrity Scanner.
"""
import sys
import json
...
try:
    from .core.sysmon_ebpf_integrity_scanner import SysmonEBPFIntegrityScannerEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        "id": "mod_050",
        "name": "sysmon_ebpf_integrity_scanner",
        "display_name": "System Call & Sysmon Telemetry Integrity Scanner",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = SysmonEBPFIntegrityScannerEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Monitors Windows Sysmon and Linux auditd telemetry pipelines for tampering or log dropping",
    version="1.0.0"
)
