# Kernel Hook & Rootkit Hunter Scanner
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/rootkit_hunter_scanner/status`).
...
│   └── rootkit_hunter_scanner.py       # Core engine and domain logic
├── tests/
│   └── test_rootkit_hunter_scanner.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/rootkit_hunter_scanner.git
   cd rootkit_hunter_scanner
   ```
...
- `GET /rootkit_hunter_scanner/status`: Current execution metrics and telemetry summary
