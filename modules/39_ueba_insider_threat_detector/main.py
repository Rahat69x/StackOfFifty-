"""
Module entry point for UEBA Behavioral Threat Detector.
"""
import sys
import json
...
try:
    from .core.ueba_insider_threat_detector import UEBAInsiderThreatDetectorEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        "id": "mod_039",
        "name": "ueba_insider_threat_detector",
        "display_name": "UEBA Behavioral Threat Detector",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = UEBAInsiderThreatDetectorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Correlates user activity baselines to flag off-hours logins and privilege escalation spikes",
    version="1.0.0"
)
