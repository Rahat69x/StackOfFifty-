# UEBA Behavioral Threat Detector
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/ueba_insider_threat_detector/status`).
...
│   └── ueba_insider_threat_detector.py       # Core engine and domain logic
├── tests/
│   └── test_ueba_insider_threat_detector.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/ueba_insider_threat_detector.git
   cd ueba_insider_threat_detector
   ```
...
- `GET /ueba_insider_threat_detector/status`: Current execution metrics and telemetry summary
