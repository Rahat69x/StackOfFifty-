...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/secure_web_bastion/status`).
...
│   └── secure_web_bastion.py       # Core engine and domain logic
├── tests/
│   └── test_secure_web_bastion.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/secure_web_bastion.git
   cd secure_web_bastion
   ```
...
- `GET /secure_web_bastion/status`: Current execution metrics and telemetry summary
