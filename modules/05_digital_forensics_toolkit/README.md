...
## Description
Parses disk timestamps, Master File Table records, and memory artifact baselines
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/digital_forensics_toolkit/status`).
...
│   └── digital_forensics_toolkit.py       # Core engine and domain logic
├── tests/
│   └── test_digital_forensics_toolkit.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/digital_forensics_toolkit.git
...
- `GET /digital_forensics_toolkit/status`: Current execution metrics and telemetry summary
