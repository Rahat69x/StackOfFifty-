"""
Module entry point for Automated Sandbox Report Parser.
"""
import sys
import json
...
try:
    from .core.cuckoo_sandbox_integrator import CuckooSandboxIntegratorEngine
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = CuckooSandboxIntegratorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Parses behavioral execution summaries from isolated sandboxes and extracts IOCs",
    version="1.0.0"
)
