# Modbus/SCADA Traffic Protocol Monitor
...
## Description
Deep inspection of Modbus TCP and DNP3 industrial automation network packet payloads
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/modbus_scada_traffic_monitor/status`).
...
│   └── modbus_scada_traffic_monitor.py       # Core engine and domain logic
├── tests/
│   └── test_modbus_scada_traffic_monitor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/modbus_scada_traffic_monitor.git
   cd modbus_scada_traffic_monitor
   ```
...
- `GET /modbus_scada_traffic_monitor/status`: Current execution metrics and telemetry summary
