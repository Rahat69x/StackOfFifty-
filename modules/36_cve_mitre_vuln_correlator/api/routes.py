"""
API routes for MITRE ATT&CK & CVE Vulnerability Correlator.
"""
from fastapi import APIRouter, HTTPException

router = APIRouter(prefix="/cve_mitre_vuln_correlator", tags=["MITRE ATT&CK & CVE Vulnerability Correlator"])
