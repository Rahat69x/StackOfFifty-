# CIS & NIST Compliance Benchmark Auditor
...
## Description
Automates validation of CIS Benchmarks and NIST SP 800-53 security controls
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/compliance_benchmark_auditor/status`).
...
│   └── compliance_benchmark_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_compliance_benchmark_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/compliance_benchmark_auditor.git
   cd compliance_benchmark_auditor
   ```
...
- `GET /compliance_benchmark_auditor/status`: Current execution metrics and telemetry summary
