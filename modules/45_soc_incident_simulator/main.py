"""
Module entry point for SOC Blue Team Incident Simulator.
"""
import sys
import json
...
try:
    from .core.soc_incident_simulator import SOCIncidentSimulatorEngine
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = SOCIncidentSimulatorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Generates structured SOC incident scenarios to evaluate analyst triage procedures",
    version="1.0.0"
)
