# E2EE Protocol & Key Exchange Auditor
...
## Description
Audits Double Ratchet and Signal Protocol forward-secrecy implementation parameters
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/e2ee_messaging_audit_core/status`).
...
│   └── e2ee_messaging_audit_core.py       # Core engine and domain logic
├── tests/
│   └── test_e2ee_messaging_audit_core.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/e2ee_messaging_audit_core.git
   cd e2ee_messaging_audit_core
   ```
...
- `GET /e2ee_messaging_audit_core/status`: Current execution metrics and telemetry summary
