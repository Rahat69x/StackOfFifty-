# Full Disk Encryption Compliance Auditor
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/fde_compliance_auditor/status`).
...
│   └── fde_compliance_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_fde_compliance_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/fde_compliance_auditor.git
   cd fde_compliance_auditor
   ```
...
- `GET /fde_compliance_auditor/status`: Current execution metrics and telemetry summary
