...
## Description
Automates verification, sandbox isolation networks, and sensor provisioning
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/lab_environment_orchestrator/status`).
...
│   └── lab_environment_orchestrator.py       # Core engine and domain logic
├── tests/
│   └── test_lab_environment_orchestrator.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/lab_environment_orchestrator.git
   cd lab_environment_orchestrator
   ```
...
- `GET /lab_environment_orchestrator/status`: Current execution metrics and telemetry summary
