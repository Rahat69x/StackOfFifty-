# Binary Unpacker & Heuristic Deobfuscator
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/packed_code_deobfuscator/status`).
...
│   └── packed_code_deobfuscator.py       # Core engine and domain logic
├── tests/
│   └── test_packed_code_deobfuscator.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/packed_code_deobfuscator.git
   cd packed_code_deobfuscator
   ```
...
- `GET /packed_code_deobfuscator/status`: Current execution metrics and telemetry summary
