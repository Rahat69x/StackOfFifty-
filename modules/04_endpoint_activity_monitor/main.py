"""
Module entry point for Endpoint Activity Monitor.
"""
import sys
import json
...
try:
    from .core.endpoint_activity_monitor import EndpointActivityMonitorEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        "id": "mod_004",
        "name": "endpoint_activity_monitor",
        "display_name": "Endpoint Activity Monitor",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = EndpointActivityMonitorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="EDR-style process tree and execution monitor for insider-threat and anomaly detection",
    version="1.0.0"
)
