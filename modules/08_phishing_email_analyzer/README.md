...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/phishing_email_analyzer/status`).
...
│   └── phishing_email_analyzer.py       # Core engine and domain logic
├── tests/
│   └── test_phishing_email_analyzer.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/phishing_email_analyzer.git
...
- `GET /phishing_email_analyzer/status`: Current execution metrics and telemetry summary
