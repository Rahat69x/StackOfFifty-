# Endpoint Antivirus Heuristic Scanner
...
## Description
Monitors filesystem integrity, evaluates heuristic entropy, and checks executable permissions
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/endpoint_av_scanner/status`).
...
│   └── endpoint_av_scanner.py       # Core engine and domain logic
├── tests/
│   └── test_endpoint_av_scanner.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/endpoint_av_scanner.git
   cd endpoint_av_scanner
   ```
...
- `GET /endpoint_av_scanner/status`: Current execution metrics and telemetry summary
