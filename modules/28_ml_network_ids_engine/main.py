"""
Module entry point for ML NetFlow Anomaly IDS Engine.
"""
import sys
import json
...
try:
    from .core.ml_network_ids_engine import MLNetworkIDSEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        "id": "mod_028",
        "name": "ml_network_ids_engine",
        "display_name": "ML NetFlow Anomaly IDS Engine",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = MLNetworkIDSEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Analyzes NetFlow and IPFIX telemetry using Isolation Forest to identify exfiltration",
    version="1.0.0"
)
