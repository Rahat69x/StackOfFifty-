...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/ml_network_ids_engine/status`).
...
│   └── ml_network_ids_engine.py       # Core engine and domain logic
├── tests/
│   └── test_ml_network_ids_engine.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/ml_network_ids_engine.git
   cd ml_network_ids_engine
   ```
...
- `GET /ml_network_ids_engine/status`: Current execution metrics and telemetry summary
