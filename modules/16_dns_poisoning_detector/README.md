...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/dns_poisoning_detector/status`).
...
│   └── dns_poisoning_detector.py       # Core engine and domain logic
├── tests/
│   └── test_dns_poisoning_detector.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/dns_poisoning_detector.git
...
- `GET /dns_poisoning_detector/status`: Current execution metrics and telemetry summary
