"""
Module entry point for DNS Poisoning Detector.
"""
import sys
import json
...
try:
    from .core.dns_poisoning_detector import DNSPoisoningDetectorEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "display_name": "DNS Poisoning Detector",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = DNSPoisoningDetectorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Monitors recursive resolver responses, validates DNSSEC signatures, and detects cache spoofing",
    version="1.0.0"
)
