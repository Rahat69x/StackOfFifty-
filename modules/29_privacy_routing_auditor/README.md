# Privacy Routing & IP Leak Auditor
...
## Description
Audits workstation routing tables for IPv6, DNS, and WebRTC telemetry leakage
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/privacy_routing_auditor/status`).
...
│   └── privacy_routing_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_privacy_routing_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/privacy_routing_auditor.git
   cd privacy_routing_auditor
   ```
...
- `GET /privacy_routing_auditor/status`: Current execution metrics and telemetry summary
