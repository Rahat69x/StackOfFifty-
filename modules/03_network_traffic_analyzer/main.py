"""
Module entry point for Network Traffic Analyzer.
"""
import sys
import json
...
try:
    from .core.network_traffic_analyzer import NetworkTrafficAnalyzerEngine
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = NetworkTrafficAnalyzerEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Performs passive network interface inspection, telemetry collection, and socket auditing",
    version="1.0.0"
)
