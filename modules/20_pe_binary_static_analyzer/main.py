"""
Module entry point for PE/ELF Binary Static Analyzer.
"""
import sys
import json
...
try:
    from .core.pe_binary_static_analyzer import PEBinaryStaticAnalyzerEngine
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = PEBinaryStaticAnalyzerEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Inspects PE/ELF headers, section hashes, import address tables, and suspicious API imports",
    version="1.0.0"
)
