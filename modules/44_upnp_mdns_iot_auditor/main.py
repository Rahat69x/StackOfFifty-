"""
Module entry point for IoT Device UPnP & mDNS Auditor.
"""
import sys
import json
...
try:
    from .core.upnp_mdns_iot_auditor import UPnPMDNSIoTAuditorEngine
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = UPnPMDNSIoTAuditorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Discovers and evaluates IoT devices exposing UPnP ports or advertising vulnerable mDNS services",
    version="1.0.0"
)
