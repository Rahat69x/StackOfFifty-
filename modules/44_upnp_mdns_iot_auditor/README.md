...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/upnp_mdns_iot_auditor/status`).
...
│   └── upnp_mdns_iot_auditor.py       # Core engine and domain logic
├── tests/
│   └── test_upnp_mdns_iot_auditor.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/upnp_mdns_iot_auditor.git
   cd upnp_mdns_iot_auditor
   ```
...
- `GET /upnp_mdns_iot_auditor/status`: Current execution metrics and telemetry summary
