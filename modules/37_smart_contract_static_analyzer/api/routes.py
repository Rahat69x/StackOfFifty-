"""
API routes for Smart Contract Static Security Auditor.
"""
from fastapi import APIRouter, HTTPException

router = APIRouter(prefix="/smart_contract_static_analyzer", tags=["Smart Contract Static Security Auditor"])
