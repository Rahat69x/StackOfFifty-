...
## Description
Audits cryptographic algorithms against NIST SP 800-131A and FIPS 140-3 guidelines
...
- **FastAPI REST API**: Native OpenAPI-compliant endpoints (`/crypto_standards_validator/status`).
...
│   └── crypto_standards_validator.py       # Core engine and domain logic
├── tests/
│   └── test_crypto_standards_validator.py     # Automated lifecycle & engine unit tests
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<your-username>/crypto_standards_validator.git
   cd crypto_standards_validator
   ```
...
- `GET /crypto_standards_validator/status`: Current execution metrics and telemetry summary
