"""
Module entry point for Honeypot Deception Sensor.
"""
import sys
import json
...
try:
    from .core.honeypot_deception_sensor import HoneypotDeceptionSensorEngine
...
def load_default_config() -> Dict[str, Any]:
    ...
    return {
        "id": "mod_001",
        "name": "honeypot_deception_sensor",
        "display_name": "Honeypot Deception Sensor",
...
class Module(BaseModule):
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.engine = HoneypotDeceptionSensorEngine(config.get("settings", {}))
...
app = FastAPI(
    ...
    description="Deploys non-intrusive decoy sensors to attract, log, and analyze unauthorized connection telemetry in a protected lab environment",
    version="1.0.0"
)
